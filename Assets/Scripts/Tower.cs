...
public class Tower : MonoBehaviour
{
    ...
    {
        EventManager.AddHandler(GameEvent.OnCreateTower, new Action<int>(OnCreateTower));
    }
    private void OnDisable()
    {
        EventManager.RemoveHandler(GameEvent.OnCreateTower, new Action<int>(OnCreateTower));
    }
    public void OnCreateTower(int stickManNo)
    {
